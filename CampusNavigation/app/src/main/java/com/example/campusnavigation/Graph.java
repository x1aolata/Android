...
public class Graph {
    ...
    // 初始化地点数据
    {
        Nodes.add(new Node("体检中心", "0", 115.568463, 38.88999, "河北大学体检专用场地"));
        Nodes.add(new Node("操场", "1", 115.572838, 38.891099, "操场是供体育锻炼用的场地，是河北大学进行体育活动和教学活动的专置场地。"));
        Nodes.add(new Node("校门北口", "2", 115.575169, 38.889526, "河北大学校门北口"));
        Nodes.add(new Node("银杏景观", "3", 115.577738, 38.889031, "河北大学银杏景观"));
        Nodes.add(new Node("邯郸音乐厅", "4", 115.56897, 38.889411, "河北大学邯郸音乐厅"));
        Nodes.add(new Node("图书馆", "5", 115.572595, 38.887894, "河北大学图书馆"));
        Nodes.add(new Node("餐厅", "6", 115.576009, 38.888122, "河北大学餐厅"));
        Nodes.add(new Node("信息学部", "7", 115.571207, 38.887059, "河北大学信息学部"));
        Nodes.add(new Node("花园景观", "8", 115.572303, 38.886111, "河北大学花园景观"));
        Nodes.add(new Node("校门东口", "9", 115.574818, 38.886585, "河北大学校门东口"));
        Nodes.add(new Node("网计学院", "10", 115.569518, 38.885668, "河北大学网计学院"));
        Nodes.add(new Node("校门南口", "11", 115.571894, 38.883077, "河北大学校门南口"));
